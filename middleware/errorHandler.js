...
const errorHandlers = {
    ...
    JsonWebTokenError: (_, res) => sendError(res, HTTP_STATUS.UNAUTHORIZED, 'Invalid token'),
    TokenExpiredError: (_, res) => sendError(res, HTTP_STATUS.UNAUTHORIZED, 'Token expired')
};
